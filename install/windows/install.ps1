...
Invoke-WebRequest "https://raw.githubusercontent.com/KevinNitroG/dotfiles/main/install/windows/prerequisiteScoop.ps1" | Invoke-Expression

Write-Host "INSTALL PREQUISITE CHOCO..."
curl "https://raw.githubusercontent.com/KevinNitroG/dotfiles/main/install/windows/prerequisiteChoco.ps1" -o "$($env:TEMP)\install_prequisite_choco.ps1"
...
curl "https://raw.githubusercontent.com/kevinnitrog/dotfiles/main/install/windows/environmentVariables.ps1" -o "$($env:TEMP)\install_environment_variables.ps1"
...
Invoke-WebRequest "https://raw.githubusercontent.com/KevinNitroG/dotfiles/main/install/windows/programmingLanguage.ps1" | Invoke-Expression

Write-Host "INSTALL APPS WITH NON ADMINISTRATOR PRIVILEGES (SCOOP, NPM, PIP)..."
Invoke-WebRequest "https://raw.githubusercontent.com/KevinNitroG/dotfiles/main/install/windows/softwares-nonadmin.ps1" | Invoke-Expression

Write-Host "INSTALL APPS WITH ADMINISTRATOR PRIVILEGES (CHOCO)..."
curl "https://raw.githubusercontent.com/kevinnitrog/dotfiles/main/install/windows/softwares-admin.ps1" -o "$($env:TEMP)\install_softwares_admin.ps1"
...
Invoke-WebRequest "https://raw.githubusercontent.com/KevinNitroG/dotfiles/main/install/windows/codingStuff.ps1" | Invoke-Expression
